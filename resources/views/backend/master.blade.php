...
<html dir="ltr" lang="en">
  <head>
    ...
    />
    <!-- Custom CSS -->
    <link href="{{asset('backend/ui') }}/assets/libs/flot/css/float-chart.css" rel="stylesheet" />
    <!-- Custom CSS -->
    <link href="{{asset('backend/ui') }}/dist/css/style.min.css" rel="stylesheet" />
  ...
  <body>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="{{asset('backend/ui') }}/assets/libs/jquery/dist/jquery.min.js"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="{{asset('backend/ui') }}/assets/libs/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    <script src="{{asset('backend/ui') }}/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
    <script src="{{asset('backend/ui') }}/assets/extra-libs/sparkline/sparkline.js"></script>
    <!--Wave Effe{{asset('backend/ui') }}s -->
    <script src="{{asset('backend/ui') }}/dist/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="{{asset('backend/ui') }}/dist/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
    <script src="{{asset('backend/ui') }}/dist/js/custom.min.js"></script>
    <!--This page JavaScript -->
    <!-- <script src="../dist/js/pages/dashboards/dashboard1.js"></script> -->
    <!-- Charts js Files -->
    <script src="{{asset('backend/ui') }}/assets/libs/flot/excanvas.js"></script>
    <script src="{{asset('backend/ui') }}/assets/libs/flot/jquery.flot.js"></script>
    <script src="{{asset('backend/ui') }}/assets/libs/flot/jquery.flot.pie.js"></script>
    <script src="{{asset('backend/ui') }}/assets/libs/flot/jquery.flot.time.js"></script>
    <script src="{{asset('backend/ui') }}/assets/libs/flot/jquery.flot.stack.js"></script>
    <script src="{{asset('backend/ui') }}/assets/libs/flot/jquery.flot.crosshair.js"></script>
    <script src="{{asset('backend/ui') }}/assets/libs/flot.tooltip/js/jquery.flot.tooltip.min.js"></script>
    <script src="{{asset('backend/ui') }}/dist/js/pages/chart/chart-page-init.js"></script>
  </body>
</html>
